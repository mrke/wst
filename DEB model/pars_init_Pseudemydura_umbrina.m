...
%% primary parameters
par.z =4.214;     free.z     = 1;    units.z = '-';          label.z = 'z';          % zoom factor; for z = 1: L_m = 1 cm
...
par.E_Hb = 800;    free.E_Hb  = 1;    units.E_Hb = 'J';       label.E_Hb = 'E_Hb';    % maturity at birth
par.E_Hp = 2.5e+05;      free.E_Hp  = 1;    units.E_Hp = 'J';       label.E_Hp = 'E_Hp';    % maturity at puberty
...
par.del_M = 0.31; free.del_M = 0;    units.del_M = '-';      label.del_M = 'del_M';  % shape coefficient
