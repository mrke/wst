...
%% primary parameters
par.z =4.275;     free.z     = 1;    units.z = '-';          label.z = 'z';          % zoom factor; for z = 1: L_m = 1 cm
...
par.v = 0.048;       free.v     = 1;    units.v = 'cm/d';       label.v = 'v';          % energy conductance
par.kap = 0.90;      free.kap   = 0;    units.kap = '-';        label.kap = 'kap';      % allocation fraction to soma
par.kap_R = 0.95;   free.kap_R = 0;    units.kap_R = '-';      label.kap_R = 'kap_R';  % reproduction efficiency
par.p_M = 360.4;       free.p_M   = 1;    units.p_M = 'J/d.cm^3'; label.p_M = '[p_M]';    % vol-spec somatic maint
...
par.E_Hb = 877;    free.E_Hb  = 1;    units.E_Hb = 'J';       label.E_Hb = 'E_Hb';    % maturity at birth
par.E_Hp = 2.537e+05;      free.E_Hp  = 1;    units.E_Hp = 'J';       label.E_Hp = 'E_Hp';    % maturity at puberty
...
par.del_M = 0.35; free.del_M = 1;    units.del_M = '-';      label.del_M = 'del_M';  % shape coefficient
...
par.s_Megg = 0.45;      free.s_Megg = 0;      units.s_Megg = '-';       label.s_Megg = 's_Megg';    % metabolic depression factor (cuts down p_M, v and k_J by this factor)
par.s_MO2 = 0.60;      free.s_MO2 = 0;      units.s_MO2 = '-';       label.s_MO2 = 's_MO2';    % metabolic depression factor (cuts down p_M, v and k_J by this factor)
