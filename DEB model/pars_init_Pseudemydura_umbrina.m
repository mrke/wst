...
%% primary parameters
par.z =4.114;     free.z     = 0;    units.z = '-';          label.z = 'z';          % zoom factor; for z = 1: L_m = 1 cm
...
par.v = 0.03;       free.v     = 0;    units.v = 'cm/d';       label.v = 'v';          % energy conductance
par.kap = 0.90;      free.kap   = 1;    units.kap = '-';        label.kap = 'kap';      % allocation fraction to soma
par.kap_R = 0.95;   free.kap_R = 0;    units.kap_R = '-';      label.kap_R = 'kap_R';  % reproduction efficiency
par.p_M = 240.4;       free.p_M   = 0;    units.p_M = 'J/d.cm^3'; label.p_M = '[p_M]';    % vol-spec somatic maint
...
par.E_Hb = 1280;    free.E_Hb  = 1;    units.E_Hb = 'J';       label.E_Hb = 'E_Hb';    % maturity at birth
par.E_Hp = 2.2e+05;      free.E_Hp  = 1;    units.E_Hp = 'J';       label.E_Hp = 'E_Hp';    % maturity at puberty
par.h_a = 6.352e-11;     free.h_a   = 0;    units.h_a = '1/d^2';    label.h_a = 'h_a';      % Weibull aging acceleration
...
par.del_M = 0.30; free.del_M = 0;    units.del_M = '-';      label.del_M = 'del_M';  % shape coefficient
...
par.s_M = .15;      free.s_M = 0;      units.s_M = '-';       label.s_M = 's_M';    % metabolic depression factor (cuts down p_M, v and k_J by this factor)
par.s_Megg = 0.85;      free.s_Megg = 0;      units.s_Megg = '-';       label.s_Megg = 's_Megg';    % metabolic depression factor (cuts down p_M, v and k_J by this factor)
...
% par.kap_P = 0.1;    free.kap_P = 0;    units.kap_P = '-';      label.kap_P = 'kap_P';  % faecation efficiency of food to faeces
% par.v = 0.03;       free.v     = 0;    units.v = 'cm/d';       label.v = 'v';          % energy conductance
% par.kap = 0.95;      free.kap   = 1;    units.kap = '-';        label.kap = 'kap';      % allocation fraction to soma
% par.kap_R = 0.95;   free.kap_R = 0;    units.kap_R = '-';      label.kap_R = 'kap_R';  % reproduction efficiency
% par.p_M = 240.4;       free.p_M   = 0;    units.p_M = 'J/d.cm^3'; label.p_M = '[p_M]';    % vol-spec somatic maint
% par.p_T =  0;       free.p_T   = 0;    units.p_T = 'J/d.cm^2'; label.p_T = '{p_T}';    % surf-spec somatic maint
% par.k_J = 0.002;    free.k_J   = 0;    units.k_J = '1/d';      label.k_J = 'k_J';      % maturity maint rate coefficient
% par.E_G = 7023;     free.E_G   = 0;    units.E_G = 'J/cm^3';   label.E_G = '[E_G]';    % spec cost for structure
% par.E_Hb = 680;    free.E_Hb  = 1;    units.E_Hb = 'J';       label.E_Hb = 'E_Hb';    % maturity at birth
% par.E_Hp = 1.2e+05;      free.E_Hp  = 1;    units.E_Hp = 'J';       label.E_Hp = 'E_Hp';    % maturity at puberty
% par.h_a = 6.352e-11;     free.h_a   = 0;    units.h_a = '1/d^2';    label.h_a = 'h_a';      % Weibull aging acceleration
% par.s_G = 1e-4;     free.s_G   = 0;    units.s_G = '-';        label.s_G = 's_G';      % Gompertz stress coefficient
% 
% %% auxiliary parameters
