...
%%
function [par, metapar, txt_par, chem] = pars_init_Pseudemydura_umbrina(metadata)
...
% %% primary parameters
% par.z =6.053;     free.z     = 0;    units.z = '-';          label.z = 'z';          % zoom factor; for z = 1: L_m = 1 cm
% par.F_m = 6.5;      free.F_m   = 0;    units.F_m = 'l/d.cm^2'; label.F_m = '{F_M}';    % max spec searching rate
% par.kap_X = 0.8;    free.kap_X = 0;    units.kap_X = '-';      label.kap_X = 'kap_X';  % digestion efficiency of food to reserve
% par.kap_P = 0.06;    free.kap_P = 0;    units.kap_P = '-';      label.kap_P = 'kap_P';  % faecation efficiency of food to faeces
% par.v = 0.09;       free.v     = 0;    units.v = 'cm/d';       label.v = 'v';          % energy conductance
% par.kap = 0.95;      free.kap   = 0;    units.kap = '-';        label.kap = 'kap';      % allocation fraction to soma
% par.kap_R = 0.95;   free.kap_R = 0;    units.kap_R = '-';      label.kap_R = 'kap_R';  % reproduction efficiency
% par.p_M = 110.38;       free.p_M   = 0;    units.p_M = 'J/d.cm^3'; label.p_M = '[p_M]';    % vol-spec somatic maint
% par.p_T =  0;       free.p_T   = 0;    units.p_T = 'J/d.cm^2'; label.p_T = '{p_T}';    % surf-spec somatic maint
% par.k_J = 0.002;    free.k_J   = 0;    units.k_J = '1/d';      label.k_J = 'k_J';      % maturity maint rate coefficient
% par.E_G = 7023;     free.E_G   = 0;    units.E_G = 'J/cm^3';   label.E_G = '[E_G]';    % spec cost for structure
% par.E_Hb = 655;    free.E_Hb  = 1;    units.E_Hb = 'J';       label.E_Hb = 'E_Hb';    % maturity at birth
% par.E_Hp = 8.072e+04;      free.E_Hp  = 0;    units.E_Hp = 'J';       label.E_Hp = 'E_Hp';    % maturity at puberty
% par.h_a = 4.352e-12;     free.h_a   = 0;    units.h_a = '1/d^2';    label.h_a = 'h_a';      % Weibull aging acceleration
% par.s_G = 1e-4;     free.s_G   = 0;    units.s_G = '-';        label.s_G = 's_G';      % Gompertz stress coefficient

%% primary parameters
par.z =5.653;     free.z     = 1;    units.z = '-';          label.z = 'z';          % zoom factor; for z = 1: L_m = 1 cm
par.F_m = 6.5;      free.F_m   = 0;    units.F_m = 'l/d.cm^2'; label.F_m = '{F_M}';    % max spec searching rate
par.kap_X = 0.8;    free.kap_X = 0;    units.kap_X = '-';      label.kap_X = 'kap_X';  % digestion efficiency of food to reserve
par.kap_P = 0.06;    free.kap_P = 0;    units.kap_P = '-';      label.kap_P = 'kap_P';  % faecation efficiency of food to faeces
par.v = 0.09;       free.v     = 1;    units.v = 'cm/d';       label.v = 'v';          % energy conductance
par.kap = 0.95;      free.kap   = 0;    units.kap = '-';        label.kap = 'kap';      % allocation fraction to soma
par.kap_R = 0.95;   free.kap_R = 0;    units.kap_R = '-';      label.kap_R = 'kap_R';  % reproduction efficiency
par.p_M = 150.38;       free.p_M   = 1;    units.p_M = 'J/d.cm^3'; label.p_M = '[p_M]';    % vol-spec somatic maint
par.p_T =  0;       free.p_T   = 0;    units.p_T = 'J/d.cm^2'; label.p_T = '{p_T}';    % surf-spec somatic maint
par.k_J = 0.002;    free.k_J   = 0;    units.k_J = '1/d';      label.k_J = 'k_J';      % maturity maint rate coefficient
par.E_G = 7023;     free.E_G   = 0;    units.E_G = 'J/cm^3';   label.E_G = '[E_G]';    % spec cost for structure
par.E_Hb = 705;    free.E_Hb  = 1;    units.E_Hb = 'J';       label.E_Hb = 'E_Hb';    % maturity at birth
par.E_Hp = 1.172e+05;      free.E_Hp  = 1;    units.E_Hp = 'J';       label.E_Hp = 'E_Hp';    % maturity at puberty
par.h_a = 4.352e-12;     free.h_a   = 0;    units.h_a = '1/d^2';    label.h_a = 'h_a';      % Weibull aging acceleration
par.s_G = 1e-4;     free.s_G   = 0;    units.s_G = '-';        label.s_G = 's_G';      % Gompertz stress coefficient

%% auxiliary parameters
par.T_A   = 19731;   free.T_A   = 0;    units.T_A = 'K';        label.T_A = 'T_A';      % Arrhenius temperature
par.T_AL   = 50000;   free.T_AL   = 0;   units.T_AL = 'K';       label.T_AL = 'T_AL';      % Arrhenius temperature
par.T_AH   = 50000;   free.T_AH   = 0;   units.T_AH = 'K';       label.T_AH = 'T_AH';      % Arrhenius temperature
par.T_L   = T_C+0;   free.T_L   = 0;    units.T_L = 'K';        label.T_L = 'T_L';      % Arrhenius temperature
par.T_H   = T_C+30;   free.T_H   = 0;    units.T_H = 'K';        label.T_H = 'T_H';      % Arrhenius temperature
par.del_M = 0.4162; free.del_M = 1;    units.del_M = '-';      label.del_M = 'del_M';  % shape coefficient
...
%par.f_tL = 0.9;     free.f_tL  = 0;    units.f_tL = '-';       label.f_tL = 'f_tL';    % scaled functional response for 1-var data
par.s_M = .1;      free.s_M = 0;      units.s_M = '-';       label.s_M = 's_M';    % metabolic depression factor (cuts down p_M, v and k_J by this factor)
par.s_Megg = 0.25;      free.s_Megg = 0;      units.s_Megg = '-';       label.s_Megg = 's_Megg';    % metabolic depression factor (cuts down p_M, v and k_J by this factor)
par.s_MO2 = 0.610;      free.s_MO2 = 0;      units.s_MO2 = '-';       label.s_MO2 = 's_MO2';    % metabolic depression factor (cuts down p_M, v and k_J by this factor)
